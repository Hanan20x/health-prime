...
export const t = {
  ...
  vitalSigns: { en: "View Vital Signs", ar: "عرض العلامات الحيوية" },
  ...
  otpSentHint: { en: "A 6-digit code was sent to your email", ar: "تم إرسال رمز مكون من 6 أرقام إلى بريدك الإلكتروني" },
  ...
  completedToday: { en: "Completed Today", ar: "المكتملة اليوم" },
  appointmentsCompletedToday: { en: "Appointments completed today", ar: "المواعيد المكتملة اليوم" },
  aiScheduledAppointments: { en: "AI-scheduled appointments", ar: "مواعيد مجدولة بالذكاء الاصطناعي" },
  ...
  // EMR Sections
  chiefComplaints: { en: "Doctor Diagnosis", ar: "تشخيص الطبيب" },
...
export function txStatDesc(description: string, lang: Lang): string {
  const descMap: Record<string, keyof typeof t> = {
    ...
    "Appointments completed today": "appointmentsCompletedToday",
    "AI-scheduled appointments": "aiScheduledAppointments",
