...
class Appointment(Base):
    ...
    visit_type: Mapped[str | None] = mapped_column(String(64), nullable=True)
    ai_explanation: Mapped[str | None] = mapped_column(Text, nullable=True)
    manual_slots_affected: Mapped[str | None] = mapped_column(Text, nullable=True)
    optimization_diffs: Mapped[str | None] = mapped_column(Text, nullable=True)  # JSON string of diffs
